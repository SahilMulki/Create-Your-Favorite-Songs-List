...
export default function SongEntry(props){
  ...
  return (
        <div key={props.track.id} className="flex w-full h-30 justify-between items-center mt-2 p-8 border-4 rounded-3xl">
          ...
          <div className="flex items-center justify-center">
            ...
            <img src={trashcanImg} alt="delete button" onClick={deleteSong} className="w-25"/>
          </div>
        </div>
  )
}